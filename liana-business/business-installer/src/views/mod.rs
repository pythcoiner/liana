...
/// Width of the scrollable-list content band: the standard entry width.
const CONTENT_WIDTH: f32 = button::STANDARD_ENTRY_WIDTH;
const USERBAR_HEIGHT: u32 = 44;
const MAX_SCROLL_HEIGHT: u32 = 500;
/// Fixed header height so the band keeps a constant height whether or not the
/// "Previous" button (taller than the breadcrumb) is shown.
...
fn layout_inner<'a>(
    ...
    let content = match content {
        ...
        LayoutContent::ScrollableList {
            ...
            let list = Container::new(list);
            let pinned = Container::new(pinned);
