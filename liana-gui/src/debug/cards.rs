...
fn constructors_view() -> Element<'static, DebugMessage> {
    ...
    let rows = vec![
        ...
        ("card::legacy_warning(\"Warning message\".into())",     card::legacy_warning("Warning message".to_string()).into()),
        ("card::error(\"Error\", \"<details>\".into())",  card::error("Error", "Detailed error tooltip".to_string()).into()),
        ("card::warning(<text>)",                    card::warning(sample())),
        ("card::warning(<text>)",                    card::soft_warning(sample()).into()),
        ("card::info(<text>)",                       card::info("Info message").into()),
        ("card::list_entry(<row>, Some(()))",         card::list_entry(clickable_row(), Some(()))),
        ("card::list_entry(<row>, None)",             card::list_entry(clickable_row(), None)),
    ];
...
fn themes_view() -> Element<'static, DebugMessage> {
    ...
    let rows = vec![
        ...
        ("theme::card::legacy_warning",       styled("Sample content", theme::card::legacy_warning)),
        ("theme::card::warning",  styled("Sample content", theme::card::warning)),
        ("theme::card::soft_warning",  styled("Sample content", theme::card::soft_warning)),
        ("theme::card::info",     styled("Sample content", theme::card::info)),
        ...
        ("card::simple { content + clickable_card }",
            card::simple(
                Column::new()
                    ...
                    .push(card::list_entry(click_row(), Some(())))
            ).into()),
