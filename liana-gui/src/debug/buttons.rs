...
const THEMES: &[(&str, StyleFn)] = &[
    ...
    ("clickable_card", theme::button::list_entry),
...
fn constructors_table(rows: Vec<ConstructorRow>) -> Column<'static, DebugMessage> {
    ...
    rows.into_iter().fold(
        Column::new().spacing(ROW_SPACING).push(header),
        |col, (path, interactive, _disabled)| col.push(constructor_row(path, interactive)),
    )
}
...
fn constructors_themed_view() -> Element<'static, DebugMessage> {
    ...
    let rows = vec![
        ...
        row("liana_ui::component::button::clickable_section(None, \"Sample\")",               || btn::clickable_section( text::text("Sample"), Some(()))),
    ];
...
fn constructors_widths_view() -> Element<'static, DebugMessage> {
    ...
    let rows = vec![
        ...
        row("btn_secondary_with_tooltip(None, \"XXL\", BtnWidth::XXL, _, tooltip)", || btn::btn_secondary_with_tooltip(None, "XXL",  Some("this is a very loooooooooooooooooooooong tooltip"), BtnWidth::XXL, None)),
    ];
    debug_assert!(rows.len() <= MAX_ROWS_PER_PAGE);
    debug_chrome(
...
fn constructors_helpers_view() -> Element<'static, DebugMessage> {
    ...
    let rows = vec![
        ...
        row("",|| btn::btn_save(None)),
        row("",|| btn::btn_cancel(None)),
        row("",|| btn::btn_ok(None)),
        row("",|| btn::btn_clear(None)),
        row("",|| btn::btn_retry(None)),
        row("",|| btn::btn_yes(None)),
        row("",|| btn::btn_no(None)),
        row("",|| btn::btn_reset_timelock(None)),
        row("",|| btn::btn_go_to_rescan(None)),
        row("",|| btn::btn_dismiss(None)),
        row("",|| btn::btn_customize(None)),
        row("",|| btn::btn_clear_all(None)),
        row("",|| btn::btn_unlock(None)),
        row("",|| btn::btn_reload(None)),
        row("",|| btn::btn_approve(None)),
        row("",|| btn::btn_send_for_approval(None)),
        row("",|| btn::btn_keep_changes(None)),
        row("",|| btn::btn_send_token(None)),
        row("",|| btn::btn_breadcrumb_previous(None)),
        row("",|| btn::btn_manage_keys(None, false)),
        row("",|| btn::btn_skip(None)),
        row("",|| btn::btn_resend_token(None)),
        row("",|| btn::btn_change_email(None)),
        row("",|| btn::btn_connect_another_email(None)),
        // Round icon button.
        row("",|| btn::icon_btn(icon::tooltip_icon(), None)),
        // Icon-only remove button.
        row("",|| btn::btn_remove(None)),
        // Spend-panel nav buttons.
        row("",|| btn::btn_delete(None)),
        row("",|| btn::btn_previous(None)),
        row("",|| btn::btn_next(None)),
        row("",|| btn::btn_add_payment(None)),
        // Menu constructors.
        row("",|| btn::menu(None, "Item", false)),
        row("",|| btn::menu(None, "Item", true)),
        row("",|| btn::menu_active(None, "Item", false)),
        row("",|| btn::menu_active(None, "Item", true)),
        row("",|| btn::menu_small(icon::wallet_icon())),
        row("",|| btn::menu_active_small(icon::wallet_icon())),
    ];
