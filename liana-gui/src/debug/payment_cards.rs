...
use liana_ui::{
    component::{
        ...
        panels::home::payment::{payment_card, FiatPrice, FiatSource, PaymentKind, UIPayment},
    },
    widget::*,
};
...
fn fiat(amount: f64, source: FiatSource) -> Option<FiatPrice> {
    Some(FiatPrice {
        amount: FiatAmount::new(amount, Currency::USD).expect("non-negative"),
        source,
    })
}
...
pub fn variants() -> Vec<Variant> {
    vec![
        ...
        Variant {
            ...
            time: time(),
            sats: 75_000,
            fiat: fiat(1_234.0, FiatSource::User),
        },
        Variant {
            ...
            time: time(),
            sats: 75_000,
            fiat: fiat(1_234.0, FiatSource::Wizardsardine),
        },
        Variant {
            ...
            time: time(),
            sats: 123_000_000,
            fiat: fiat(1_234.0, FiatSource::Timestamp),
        },
        Variant {
            ...
            time: None,
            sats: 42_000,
            fiat: fiat(12.0, FiatSource::User),
        },
        Variant {
            label: None,
            kind: PaymentKind::Incoming,
            time: time(),
            sats: 2_100_000,
            fiat: fiat(34.0, FiatSource::Timestamp),
        },
    ]
}
