...
// Business renders the tinted note (radius 12, width-1 border). The wallet keeps its
// existing radius-16 callout, whose border tracks the theme button border width.
